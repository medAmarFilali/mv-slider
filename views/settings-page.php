<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="?page=mv_slider_admin&tab=additional_options" class="nav-tab <?php echo ( $active_tab == 'additional_options' ) ? 'nav-tab-active' : '' ?>"><?php esc_html_e( 'Addintional options' ); ?></a>
    </h2>
